...
export const mockTariffs: Tariff[] = [
  { id: 't1', name: 'Standard 12', mfoName: 'Ipoteka Bank MFO', interestRate: 18, minAmount: 1000000, maxAmount: 10000000, minMonths: 3, maxMonths: 12, status: 'APPROVED', createdAt: '2026-01-10', approvedAt: '2026-01-12' },
  { id: 't2', name: 'Premium 24', mfoName: 'Ipoteka Bank MFO', interestRate: 22, minAmount: 5000000, maxAmount: 50000000, minMonths: 6, maxMonths: 24, status: 'APPROVED', createdAt: '2026-01-15', approvedAt: '2026-01-17' },
  { id: 't3', name: 'Micro 6', mfoName: 'Hamkorbank MFO', interestRate: 24, minAmount: 500000, maxAmount: 3000000, minMonths: 1, maxMonths: 6, status: 'PENDING', createdAt: '2026-03-20' },
  { id: 't4', name: 'Express 18', mfoName: 'Agrobank MFO', interestRate: 20, minAmount: 2000000, maxAmount: 20000000, minMonths: 6, maxMonths: 18, status: 'PENDING', createdAt: '2026-03-22' },
  { id: 't5', name: 'VIP 36', mfoName: 'Kapitalbank MFO', interestRate: 19, minAmount: 10000000, maxAmount: 100000000, minMonths: 12, maxMonths: 36, status: 'REJECTED', createdAt: '2026-02-01' },
]
...
export const mockProducts: Product[] = [
  { id: 'p1', merchantId: 'm1', name: 'Samsung Galaxy S24', category: 'Smartphones', price: 8500000, description: '256GB, Phantom Black', available: true },
  { id: 'p2', merchantId: 'm1', name: 'MacBook Air M2', category: 'Laptops', price: 22000000, description: '8GB RAM, 256GB SSD', available: true },
  { id: 'p3', merchantId: 'm1', name: 'Sony Bravia 55"', category: 'TVs', price: 12000000, description: '4K OLED Smart TV', available: true },
  { id: 'p4', merchantId: 'm1', name: 'iPhone 15 Pro', category: 'Smartphones', price: 18000000, description: '128GB, Natural Titanium', available: false },
  { id: 'p5', merchantId: 'm2', name: 'Xiaomi 14', category: 'Smartphones', price: 7200000, description: '12GB RAM, Leica cameras', available: true },
  { id: 'p6', merchantId: 'm3', name: 'LG Washing Machine', category: 'Appliances', price: 6500000, description: '9kg, Inverter', available: true },
]
...
export const mockApplications: Application[] = [
  ...
  { id: 'a5', merchantId: 'm1', merchantName: 'TechMart Savdo', clientName: 'Doniyor Tursunov', clientPhone: '+998901230005', productName: 'Sony Bravia 55"', productPrice: 12000000, tariffId: 't2', tariffName: 'Premium 24', months: 18, monthlyPayment: 800000, totalAmount: 14400000, score: 88, status: 'ACTIVE', createdAt: '2026-02-10', decidedAt: '2026-02-11' },
]
